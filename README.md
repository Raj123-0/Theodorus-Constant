Theodorus Constant Calculator (HPC OEIS Edition)
======================================================

Calculates Theodorus Constant to an arbitrary precision of [N] significant digits using a highly optimized 12-core parallelized algorithm.
...
Usage:
    python "Theodorus Constant.py" -n 1000
